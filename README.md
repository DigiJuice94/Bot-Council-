...
## Tournament.11 GitHub-safe turnover release
...
The Docker build reads the checked-in source tree directly. It does not require or unpack a nested deployment archive, which keeps GitHub and Railway uploads small and prevents the pre-build source check from failing.
