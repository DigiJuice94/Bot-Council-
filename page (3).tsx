...
export default function Cabinets(){const [kind,setKind]=useState<Kind>("proof");const [data,setData]=useState<any>(null);const [err,setErr]=useState("");
 ...
 return <><header className="primary-app-nav"><a className="app-nav-brand" href="/">BOT WAR ROOM <small>V3.6.3.2</small></a><nav><a href="/">TRADING DASHBOARD</a><a className="active cabinet-nav-callout" href="/cabinets">FILE CABINETS & DOWNLOADS <b>3</b></a></nav></header><div className="workspace-switcher"><a href="/"><small>WORKSPACE 01</small><strong>Trading Dashboard</strong><span>Live wallet, positions and trade ledger</span></a><a className="active" href="/cabinets"><small>WORKSPACE 02</small><strong>File Cabinets & Downloads</strong><span>Main · Rug · Proof of Work</span></a></div><main className="cabinet-page"><header className="cabinet-top"><div><small>V3.6.3.2 · MONITORING PHASE</small><h1>Intelligence File Cabinets</h1><p>Read-only evidence and learning. Nothing on this page can place, alter or stop a trade.</p></div><a className="back-trading" href="/">← Trading</a></header>
